...
public class UserController {
    ...
    public HttpResponse getAllUserList(HttpRequest httpRequest) {
        ...
        return new HttpResponse.Builder()
                ...
                .body(getUserListPage(UserService.getInstance().getUserList()).getBytes())
                .build();

    }

    public String getUserListPage(List<User> userList) {
        ...
        for (int i = 0; i < userList.size(); i++) {
            ...
            sb.append("                <tr>\n" +
                    "                    <th scope=\"row\">" + (i + 1) + "</th> <td>" + userId + "</td> <td>" + name + "</td> <td>" + email + "</td><td><a href=\"#\" class=\"btn btn-success\" role=\"button\">수정</a></td>\n" +
                    "                </tr>\n");
        }
