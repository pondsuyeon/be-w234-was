...
//
//        HttpRequest actualRequest = RequestParser.getHttpRequestFromInput(startLine, null, bodyData);
...
//    }
    ...
    private HttpRequest initExpectedRequest() {
        ...
        return new HttpRequest(Method.GET, "/user/create", "HTTP/1.1", parameters, null, null);
    }
}